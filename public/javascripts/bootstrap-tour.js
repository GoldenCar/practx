        ...
        Tour = (function() {
            function Tour(options) {
                this._options = $.extend({
                    ...
                    template: "<div class='popover tour'>            <div class='arrow arr-shadow'></div> <div class='arrow'></div>           <div class='shadow'> <h3 class='popover-title'></h3>            <div class='popover-content'></div> </div>         </div>",
                    container: 'body',
                    keyboard: true,
            ...
            Tour.prototype._renderNavigation = function(step, options) {
                ...
                nav = [];
                if (step.prev >= 0) {
                    nav.push("<button href='#" + step.prev + "' class='prev pull-left btn btn-white'>" + options.labels.prev + "</button>");
                }
                else{
                    nav.push("<div class='pull-left btn btn-white' style='color: grey'>" + options.labels.prev + "</div>");
                }

                if (step.next >= 0) {
                    nav.push("<button href='#" + step.next + "' class='next pull-right btn btn-white'>" + options.labels.next + "</button>");
                }
                else{
                    nav.push("<button href='#' class='pull-right btn btn-white end'>Done</button>");
                }
                content = "<div class='nav-area'><span class='muted central-number'>"+(this._current+1)+" of "+this._steps.length+"</span>";
                content += nav.join("");
                content += "<div class='clearfix'></div></div>";
                return content += "<a href='#' class='end cross'>"+options.labels.end+"</a>";
            };
